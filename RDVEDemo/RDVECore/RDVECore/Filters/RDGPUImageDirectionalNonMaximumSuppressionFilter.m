...
@implementation RDGPUImageDirectionalNonMaximumSuppressionFilter

#if TARGET_IPHONE_SIMULATOR || TARGET_OS_IPHONE
NSString *const kRDGPUImageDirectionalNonmaximumSuppressionFragmentShaderString = SHADER_STRING
(
...
- (id)init;
{
    if (!(self = [super initWithFragmentShaderFromString:kRDGPUImageDirectionalNonmaximumSuppressionFragmentShaderString]))
    {
        return nil;
    }
