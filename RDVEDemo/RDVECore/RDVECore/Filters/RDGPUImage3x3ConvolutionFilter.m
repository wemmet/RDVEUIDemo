...
NSString *const kRDGPUImage3x3ConvolutionFragmentShaderString = SHADER_STRING
(
...
@implementation RDGPUImage3x3ConvolutionFilter
...
- (id)init;
{
    if (!(self = [self initWithFragmentShaderFromString:kRDGPUImage3x3ConvolutionFragmentShaderString]))
    {
		return nil;
    }

    self.convolutionKernel = (RDGPUMatrix3x3){
        {0.f, 0.f, 0.f},
        {0.f, 1.f, 0.f},
        {0.f, 0.f, 0.f}
    };
...
- (void)setConvolutionKernel:(RDGPUMatrix3x3)newValue;
{
