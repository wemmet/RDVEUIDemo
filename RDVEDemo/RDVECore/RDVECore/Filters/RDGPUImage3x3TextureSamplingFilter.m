...
NSString *const kRDGPUImageNearbyTexelSamplingVertexShaderString = SHADER_STRING
(
...
@implementation RDGPUImage3x3TextureSamplingFilter
...
{
    if (!(self = [self initWithVertexShaderFromString:kRDGPUImageNearbyTexelSamplingVertexShaderString fragmentShaderFromString:fragmentShaderString]))
    {
        return nil;
    }
