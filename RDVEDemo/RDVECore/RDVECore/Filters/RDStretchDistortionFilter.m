...
NSString *const kRDStretchDistortionFragmentShaderString = SHADER_STRING
(
...
@implementation RDStretchDistortionFilter
...
- (id)init;
{
    if (!(self = [super initWithFragmentShaderFromString:kRDStretchDistortionFragmentShaderString]))
    {
		return nil;
    }
