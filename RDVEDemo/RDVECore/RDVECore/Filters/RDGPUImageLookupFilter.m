...
#import "RDGPUImageLookupFilter.h"
#if TARGET_IPHONE_SIMULATOR || TARGET_OS_IPHONE
NSString *const kRDGPUImageLookupFragmentShaderString = SHADER_STRING
(
...
#endif
@implementation RDGPUImageLookupFilter
...
- (id)init;
{
    if (!(self = [super initWithFragmentShaderFromString:kRDGPUImageLookupFragmentShaderString]))
    {
        return nil;
    }
