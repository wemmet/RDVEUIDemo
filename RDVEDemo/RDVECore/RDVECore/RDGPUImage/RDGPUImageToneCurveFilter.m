...
#pragma mark -
#pragma mark RDGPUImageToneCurveFilter Implementation

#if TARGET_IPHONE_SIMULATOR || TARGET_OS_IPHONE
NSString *const kRDGPUImageToneCurveFragmentShaderString = SHADER_STRING
(
...
@interface RDGPUImageToneCurveFilter()
{
...
@implementation RDGPUImageToneCurveFilter
...
- (id)init;
{
    if (!(self = [super initWithFragmentShaderFromString:kRDGPUImageToneCurveFragmentShaderString]))
    {
		return nil;
    }
...
- (id)initWithACVData:(NSData *)data {
    ...
    RDGPUImageACVFile *curve = [[RDGPUImageACVFile alloc] initWithACVFileData:data];
