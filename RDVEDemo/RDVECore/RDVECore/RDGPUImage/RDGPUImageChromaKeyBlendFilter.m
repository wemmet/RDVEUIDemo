...
NSString *const kRDGPUImageChromaKeyBlendFragmentShaderString = SHADER_STRING
(
...
@implementation RDGPUImageChromaKeyBlendFilter
...
- (id)init;
{
    if (!(self = [super initWithFragmentShaderFromString:kRDGPUImageChromaKeyBlendFragmentShaderString]))
    {
		return nil;
    }
...
{
    RDGPUVectore3 colorToReplace = {redComponent, greenComponent, blueComponent};
