...
#import "RDGPUImage3x3ConvolutionFilter.h"

//   Code from "Graphics Shaders: Theory and Practice" by M. Bailey and S. Cunningham 
#if TARGET_IPHONE_SIMULATOR || TARGET_OS_IPHONE
NSString *const kRDGPUImageSobelEdgeDetectionFragmentShaderString = SHADER_STRING
(
...
@implementation RDGPUImageSobelEdgeDetectionFilter
...
- (id)init;
{
    if (!(self = [self initWithFragmentShaderFromString:kRDGPUImageSobelEdgeDetectionFragmentShaderString]))
    {
		return nil;
    }
...
- (id)initWithFragmentShaderFromString:(NSString *)fragmentShaderString;
{
    ...
    if (!(self = [super initWithFirstStageVertexShaderFromString:kRDGPUImageVertexShaderString firstStageFragmentShaderFromString:kRDGPUImageLuminanceFragmentShaderString secondStageVertexShaderFromString:kRDGPUImageNearbyTexelSamplingVertexShaderString secondStageFragmentShaderFromString:fragmentShaderString]))
    {
		return nil;
    }
