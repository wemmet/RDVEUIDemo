...
@class RDGPUImageGrayscaleFilter;
@class RDGPUImageSingleComponentGaussianBlurFilter;
@class RDGPUImageDirectionalSobelEdgeDetectionFilter;
@class RDGPUImageDirectionalNonMaximumSuppressionFilter;
@class RDGPUImageWeakPixelInclusionFilter;
 ...
 */
@interface RDGPUImageCannyEdgeDetectionFilter : RDGPUImageFilterGroup
{
    RDGPUImageGrayscaleFilter *luminanceFilter;
    RDGPUImageSingleComponentGaussianBlurFilter *blurFilter;
    RDGPUImageDirectionalSobelEdgeDetectionFilter *edgeDetectionFilter;
    RDGPUImageDirectionalNonMaximumSuppressionFilter *nonMaximumSuppressionFilter;
    RDGPUImageWeakPixelInclusionFilter *weakPixelInclusionFilter;
}
