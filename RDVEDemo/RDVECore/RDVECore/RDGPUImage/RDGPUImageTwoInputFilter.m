...
NSString *const kRDGPUImageTwoInputTextureVertexShaderString = SHADER_STRING
(
...
@implementation RDGPUImageTwoInputFilter
...
{
    if (!(self = [self initWithVertexShaderFromString:kRDGPUImageTwoInputTextureVertexShaderString fragmentShaderFromString:fragmentShaderString]))
    {
		return nil;
    }
...
- (id)initWithVertexShaderFromString:(NSString *)vertexShaderString fragmentShaderFromString:(NSString *)fragmentShaderString;
{
    ...
    inputRotation2 = kRDGPUImageNoRotation;
