...
@interface RDGPUImageFilterPipeline ()
...
@implementation RDGPUImageFilterPipeline
...
- (BOOL)_parseConfiguration:(NSDictionary *)configuration {
    ...
    for (NSDictionary *filter in filters) {
        ...
        RDGPUImageOutput<RDGPUImageInput> *genericFilter = [[theClass alloc] init];
...
- (void)_refreshFilters {
    ...
    RDGPUImageOutput<RDGPUImageInput> *theFilter = nil;
...
- (UIImage *)currentFilteredFrame {
    return [(RDGPUImageOutput<RDGPUImageInput> *)[_filters lastObject] imageFromCurrentFramebuffer];
}

- (UIImage *)currentFilteredFrameWithOrientation:(UIImageOrientation)imageOrientation {
  return [(RDGPUImageOutput<RDGPUImageInput> *)[_filters lastObject] imageFromCurrentFramebufferWithOrientation:imageOrientation];
}

- (CGImageRef)newCGImageFromCurrentFilteredFrame {
    return [(RDGPUImageOutput<RDGPUImageInput> *)[_filters lastObject] newCGImageFromCurrentlyProcessedOutput];
}
