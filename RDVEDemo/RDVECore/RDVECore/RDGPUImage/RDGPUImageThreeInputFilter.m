...
NSString *const kRDGPUImageThreeInputTextureVertexShaderString = SHADER_STRING
(
...
@implementation RDGPUImageThreeInputFilter
...
{
    if (!(self = [self initWithVertexShaderFromString:kRDGPUImageThreeInputTextureVertexShaderString fragmentShaderFromString:fragmentShaderString]))
    {
		return nil;
    }
...
- (id)initWithVertexShaderFromString:(NSString *)vertexShaderString fragmentShaderFromString:(NSString *)fragmentShaderString;
{
    ...
    inputRotation3 = kRDGPUImageNoRotation;
...
- (CGSize)rotatedSize:(CGSize)sizeToRotate forIndex:(NSInteger)textureIndex;
{
    ...
    RDGPUImageRotationMode rotationToCheck;
    if (textureIndex == 0)
    {
    ...
    if (RDGPUImageRotationSwapsWidthAndHeight(rotationToCheck))
    {
