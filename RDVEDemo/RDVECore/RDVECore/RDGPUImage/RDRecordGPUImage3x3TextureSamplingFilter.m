...
NSString *const kRDRecordGPUImageNearbyTexelSamplingVertexShaderString = SHADER_STRING
(
...
@implementation RDRecordGPUImage3x3TextureSamplingFilter
...
{
    if (!(self = [self initWithVertexShaderFromString:kRDRecordGPUImageNearbyTexelSamplingVertexShaderString fragmentShaderFromString:fragmentShaderString]))
    {
        return nil;
    }
