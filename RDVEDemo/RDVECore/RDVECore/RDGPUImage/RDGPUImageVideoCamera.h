...
@protocol RDGPUImageVideoCameraDelegate <NSObject>
...
/**
 A RDGPUImageOutput that provides frames from either camera
*/
@interface RDGPUImageVideoCamera : RDGPUImageOutput <AVCaptureVideoDataOutputSampleBufferDelegate, AVCaptureAudioDataOutputSampleBufferDelegate>
{
    ...
    BOOL capturePaused;
    RDGPUImageRotationMode outputRotation, internalRotation;
    dispatch_semaphore_t frameRenderingSemaphore;
    BOOL captureAsYUV;
    GLuint luminanceTexture, chrominanceTexture;

    __unsafe_unretained id<RDGPUImageVideoCameraDelegate> _delegate;
}
...
@property(nonatomic, assign) id<RDGPUImageVideoCameraDelegate> delegate;
