...
@implementation NSData (RDEncrypt)
 ...
 *  @return data
 */
- (NSData*)rd_encryptedWithAESUsingKey:(NSString*)key andIV:(NSData*)iv {
 ...
 *  @return 解密后数据
 */
- (NSData*)rd_decryptedWithAESUsingKey:(NSString*)key andIV:(NSData*)iv {
 ...
 *  @return data
 */
- (NSData*)rd_encryptedWith3DESUsingKey:(NSString*)key andIV:(NSData*)iv {
 ...
 *  @return 解密后数据
 */
- (NSData*)rd_decryptedWith3DESUsingKey:(NSString*)key andIV:(NSData*)iv {
