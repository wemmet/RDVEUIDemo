//
//  RDLOTAnimationTransitionController.h
//  RDLottie
//
...
/** RDLOTAnimationTransitionController
 *
 *  This class creates a custom UIViewController transition animation
 *  using a RDLottie animation to transition between two view controllers
...
@interface RDLOTAnimationTransitionController : NSObject <UIViewControllerAnimatedTransitioning>

/**
 The initializer to create a new transition animation.
 
 @param animation The name of the RDLottie Animation to load for the transition
 
 @param fromLayer The name of the custom layer to mask the fromVC screenshot with.
 If no layer is specified then the screenshot is added behind the RDLottie Animation
 
 @param toLayer The name of the custom layer to mask the toVC screenshot with.
 If no layer is specified then the screenshot is added behind the RDLottie Animation
 and a fade transition is performed along with the RDLottie animation.
