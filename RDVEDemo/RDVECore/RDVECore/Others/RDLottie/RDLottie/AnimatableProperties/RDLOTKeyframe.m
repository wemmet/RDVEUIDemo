...
- (instancetype)initWithRDLOTKeyframe:(RDLOTKeyframe *)keyframe {
  self = [super init];
  if (self) {
...
- (RDLOTKeyframe *)copyWithData:(id)data {
  RDLOTKeyframe *newFrame = [[RDLOTKeyframe alloc] initWithRDLOTKeyframe:self];
...
- (void)setupOutputWithData:(id)data {
  ...
  if ([data isKindOfClass:[NSArray class]] &&
    ...
    _pathData = [[RDLOTBezierData alloc] initWithData:[(NSArray *)data firstObject]];
  } else if ([data isKindOfClass:[NSDictionary class]]) {
    _pathData = [[RDLOTBezierData alloc] initWithData:data];
  }
}
...
@implementation RDLOTKeyframeGroup
...
- (void)buildKeyframesFromData:(id)data {
  if ([data isKindOfClass:[NSArray class]] &&
    ...
    for (NSDictionary *keyframe in keyframes) {
      ...
      RDLOTKeyframe *key = [[RDLOTKeyframe alloc] initWithKeyframe:currentFrame];
      [keys addObject:key];
    ...
    RDLOTKeyframe *key = [[RDLOTKeyframe alloc] initWithValue:data];
    _keyframes = @[key];
  }
}

- (void)remapKeyframesWithBlock:(CGFloat (^)(CGFloat))remapBlock {
  for (RDLOTKeyframe *keyframe in _keyframes) {
