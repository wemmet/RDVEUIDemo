//
//  RDLOTAnimationTransitionController.m
//  RDLottie
//
...
@implementation RDLOTAnimationTransitionController {
  RDLOTAnimationView *transitionAnimationView_;
...
- (instancetype)initWithAnimationNamed:(NSString *)animation
  ...
  self = [super init];
  if (self) {
    transitionAnimationView_ = [RDLOTAnimationView animationNamed:animation inBundle:bundle];
...
- (void)animateTransition:(id<UIViewControllerContextTransitioning>)transitionContext {
  ...
  if (toLayerName_.length) {
    RDLOTKeypath *toKeypath = [RDLOTKeypath keypathWithString:toLayerName_];
  ...
  if (fromLayerName_.length) {
    RDLOTKeypath *fromKeypath = [RDLOTKeypath keypathWithString:fromLayerName_];
