...
@interface RDCollageViewController ()<RDVECoreDelegate,UIScrollViewDelegate,UIAlertViewDelegate,RDAddEffectsByTimelineDelegate>
{
    RDVECore                * rdPlayer;
...
@implementation RDCollageViewController
...
- (void)viewDidLoad {
    ...
    _addEffectsByTimeline.currentEffect = RDAdvanceEditType_Collage;
    _addEffectsByTimeline.currentTimeLbl.text = @"0.00";
    
    [_addEffectsByTimeline initAlbumTitleToolbarWithFrame:CGRectMake(44, kHEIGHT - kToolbarHeight, kWIDTH - 44*2, 44)];
    [_addEffectsByTimeline initAlbumViewWithFrame:_addEffectsByTimelineView.frame];
    [self.view addSubview:_addEffectsByTimeline.albumTitleView];
...
- (void)initTitleView{
    ...
    titleLbl.text = RDLocalizedString(@"画中画", nil);
...
- (void)initToolBarView{
    ...
    [cancelBtn addTarget:self action:@selector(cancelEditCollage) forControlEvents:UIControlEventTouchUpInside];
    ...
    [finishAddSubtitleBtn addTarget:self action:@selector(finishEditCollage) forControlEvents:UIControlEventTouchUpInside];
...
- (void)cancelEditCollage {
    ...
    if (_isAddingMaterialEffect || _isEdittingMaterialEffect)
    {
        if( (_addEffectsByTimeline.EditCollageView) && (_addEffectsByTimeline.EditCollageView.hidden == NO) )
        {
            //画中画 编辑功能
                ...
                isSaveEffect:(BOOL)isSaveEffect
{
    ...
    if( _addEffectsByTimeline.isBlankCaptionRangeView )
        [self initPlayer];
...
{
    CGRect bottomViewRect = CGRectMake(0,  _playerView.frame.size.height + _playerView.frame.origin.y, kWIDTH, kHEIGHT - (_playerView.frame.size.height + _playerView.frame.origin.y) - kToolbarHeight);
        switch (pipType) {
                case kPIP_SINGLEFILTER: //MARK:画中画 滤镜
                {
                    ...
                    collage_filter_View.globalFilters = _globalFilters;
                    ...
                    [collage_filter_View setNewFilterSortArray:_NewFilterSortArray];
                    [collage_filter_View setNewFiltersNameSortArray:_NewFiltersNameSortArray];
                    ...
                    if( _addEffectsByTimeline.EditCollageView.videoCoreSDK )
                        ...
                        collage_filter_View.videoCoreSDK = rdPlayer;
                }
                    break;
        ...
        //            collage_toni_View.videoCoreSDK = _addEffectsByTimeline.EditCollageView.videoCoreSDK;
                    ...
                    if( _addEffectsByTimeline.EditCollageView.videoCoreSDK )
                        ...
                        collage_toni_View.videoCoreSDK = rdPlayer;
                }
                    break;
                case kPIP_MIXEDMODE://MARK:画中画 混合模式
                {
                    ...
                    if( _addEffectsByTimeline.EditCollageView.videoCoreSDK )
                        ...
                        collage_mixed_View.videoCoreSDK = rdPlayer;
        ...
        //            collage_cutout_View.videoCoreSDK = _addEffectsByTimeline.EditCollageView.videoCoreSDK;
                    ...
                    if( _addEffectsByTimeline.EditCollageView.videoCoreSDK )
                        ...
                        collage_cutout_View.videoCoreSDK = rdPlayer;
        ...
        //            collage_volume_View.videoCoreSDK = _addEffectsByTimeline.EditCollageView.videoCoreSDK;
                    ...
                    if( _addEffectsByTimeline.EditCollageView.videoCoreSDK )
                        ...
                        collage_volume_View.videoCoreSDK = rdPlayer;
        ...
        //            collage_beautay_View.videoCoreSDK = _addEffectsByTimeline.EditCollageView.videoCoreSDK;
                    ...
                    if( _addEffectsByTimeline.EditCollageView.videoCoreSDK )
                        ...
                        collage_beautay_View.videoCoreSDK = rdPlayer;
        ...
        //            collage_transparency_View.videoCoreSDK = _addEffectsByTimeline.EditCollageView.videoCoreSDK;
                    ...
                    if( _addEffectsByTimeline.EditCollageView.videoCoreSDK )
                        ...
                        collage_transparency_View.videoCoreSDK = rdPlayer;
