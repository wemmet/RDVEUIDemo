//
//  RDTTRangeSliderView.h
//
//  Created by Tom Thorpe
//

#import <UIKit/UIKit.h>
#import "RDTTRangeSliderDelegate.h"
#import "RDDragGestureRecognizer.h"

IB_DESIGNABLE
@interface RDTTRangeSlider : UIControl <UIGestureRecognizerDelegate>
...
@property (nonatomic, weak) id<RDTTRangeSliderDelegate> delegate;

/**酷玩特效：拖动该按钮可平移特效位置
 */
@property (nonatomic, strong) UIButton  *moveCaptionViewBtn;
@property (nonatomic, strong) RDDragGestureRecognizer *holdDragRecognizer;
