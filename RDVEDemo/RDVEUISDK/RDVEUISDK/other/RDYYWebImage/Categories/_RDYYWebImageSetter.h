...
extern NSString *const _RDYYWebImageFadeAnimationKey;
extern const NSTimeInterval _RDYYWebImageFadeTime;
extern const NSTimeInterval _RDYYWebImageProgressiveFadeTime;

/**
 Private class used by web image categories.
 Typically, you should not use this class directly.
 */
@interface _RDYYWebImageSetter : NSObject
/// Current image url.
