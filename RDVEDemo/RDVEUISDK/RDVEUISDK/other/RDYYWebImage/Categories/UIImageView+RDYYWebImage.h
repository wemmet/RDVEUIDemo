 ...
 */
@interface UIImageView (RDYYWebImage)
...
/**
 ...
 @param options  The options to use when request the image.
 */
- (void)yy_setHighlightedImageWithURL:(nullable NSURL *)imageURL options:(RDYYWebImageOptions)options;
