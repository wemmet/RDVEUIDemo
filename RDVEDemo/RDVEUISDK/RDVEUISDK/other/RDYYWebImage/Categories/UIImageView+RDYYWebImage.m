...
@interface UIImageView_RDYYWebImage : NSObject @end
@implementation UIImageView_RDYYWebImage @end

static int _RDYYWebImageSetterKey;
static int _RDYYWebImageHighlightedSetterKey;


@implementation UIImageView (RDYYWebImage)
...
- (NSURL *)yy_highlightedImageURL {
    _RDYYWebImageSetter *setter = objc_getAssociatedObject(self, &_RDYYWebImageHighlightedSetterKey);
    return setter.imageURL;
}
...
- (void)yy_setHighlightedImageWithURL:(NSURL *)imageURL options:(RDYYWebImageOptions)options {
    [self yy_setHighlightedImageWithURL:imageURL
                            placeholder:nil
                                options:options
                                manager:nil
...
- (void)yy_setHighlightedImageWithURL:(NSURL *)imageURL
    ...
    if (!setter) {
        setter = [_RDYYWebImageSetter new];
        objc_setAssociatedObject(self, &_RDYYWebImageHighlightedSetterKey, setter, OBJC_ASSOCIATION_RETAIN_NONATOMIC);
    }
    int32_t sentinel = [setter cancelWithNewURL:imageURL];
