...
/**
 The RDYYWebImageOperation class is an NSOperation subclass used to fetch image 
 from URL request.
 ...
 */
@interface RDYYWebImageOperation : NSOperation
...
@property (nullable, nonatomic, strong, readonly) RDYYImageCache      *cache;    ///< The image cache.
@property (nonatomic, strong, readonly)           NSString          *cacheKey; ///< The image cache key.
@property (nonatomic, readonly)                   RDYYWebImageOptions options;   ///< The operation's option.
...
- (instancetype)initWithRequest:(NSURLRequest *)request
                        options:(RDYYWebImageOptions)options
                          cache:(nullable RDYYImageCache *)cache
                       cacheKey:(nullable NSString *)cacheKey
                       progress:(nullable RDYYWebImageProgressBlock)progress
                      transform:(nullable RDYYWebImageTransformBlock)transform
                     completion:(nullable RDYYWebImageCompletionBlock)completion NS_DESIGNATED_INITIALIZER;
