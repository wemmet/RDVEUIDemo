...
/**
 ...
 The animation can be played by RDYYAnimatedImageView.
 ...
 Sample Code:
    ...
    RDYYSpriteSheetImage *sprite;
    sprite = [[RDYYSpriteSheetImage alloc] initWithSpriteSheetImage:img
                                                     contentRects:contentRects
                                                   frameDurations:durations
                                                        loopCount:0];
    RDYYAnimatedImageView *imgView = [RDYYAnimatedImageView new];
