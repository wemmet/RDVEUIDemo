...
/**
 Image file type.
 */
typedef NS_ENUM(NSUInteger, RDYYImageType) {
    RDYYImageTypeUnknown = 0, ///< unknown
    RDYYImageTypeJPEG,        ///< jpeg, jpg
    RDYYImageTypeJPEG2000,    ///< jp2
    RDYYImageTypeTIFF,        ///< tiff, tif
    RDYYImageTypeBMP,         ///< bmp
    RDYYImageTypeICO,         ///< ico
    RDYYImageTypeICNS,        ///< icns
    RDYYImageTypeGIF,         ///< gif
    RDYYImageTypePNG,         ///< png
    RDYYImageTypeWebP,        ///< webp
    RDYYImageTypeOther,       ///< other image format
};
 ...
 */
typedef NS_ENUM(NSUInteger, RDYYImageBlendOperation) {
    
    /**
     All color components of the frame, including alpha, overwrite the current
     contents of the frame's canvas region.
     */
    RDYYImageBlendNone = 0,
 ...
 */
@interface RDYYImageFrame : NSObject <NSCopying>
...
@property (nonatomic) RDYYImageDisposeMethod dispose;     ///< Frame dispose method.
@property (nonatomic) RDYYImageBlendOperation blend;      ///< Frame blend operation.
...
/**
 ...
 Example:
    ...
    RDYYImageDecoder *decoder = [RDYYImageDecoder decoderWithData:data scale:2.0];
    UIImage image = [decoder frameAtIndex:0 decodeForDisplay:YES].image;
 
    // Decode image during download:
    NSMutableData *data = [NSMutableData new];
    RDYYImageDecoder *decoder = [[RDYYImageDecoder alloc] initWithScale:2.0];
 ...
 */
@interface RDYYImageDecoder : NSObject

@property (nullable, nonatomic, readonly) NSData *data;    ///< Image data.
@property (nonatomic, readonly) RDYYImageType type;          ///< Image data type.
 ...
 */
- (nullable RDYYImageFrame *)frameAtIndex:(NSUInteger)index decodeForDisplay:(BOOL)decodeForDisplay;
...
/**
 ...
 @discussion It supports encoding single frame image with the type defined in RDYYImageType.
 It also supports encoding multi-frame image with GIF, APNG and WebP.
 
 Example:
    
    RDYYImageEncoder *jpegEncoder = [[RDYYImageEncoder alloc] initWithType:RDYYImageTypeJPEG];
    jpegEncoder.quality = 0.9;
    [jpegEncoder addImage:image duration:0];
    NSData jpegData = [jpegEncoder encode];
 
    RDYYImageEncoder *gifEncoder = [[RDYYImageEncoder alloc] initWithType:RDYYImageTypeGIF];
 ...
 */
@interface RDYYImageEncoder : NSObject

@property (nonatomic, readonly) RDYYImageType type; ///< Image type.
 ...
 */
- (nullable instancetype)initWithType:(RDYYImageType)type NS_DESIGNATED_INITIALIZER;
...
/**
 ...
 @return The image data, or nil if an error occurs.
 */
+ (nullable NSData *)encodeImage:(UIImage *)image type:(RDYYImageType)type quality:(CGFloat)quality;
...
/**
 ...
 @return The image data, or nil if an error occurs.
 */
+ (nullable NSData *)encodeImageWithDecoder:(RDYYImageDecoder *)decoder type:(RDYYImageType)type quality:(CGFloat)quality;
...
@interface UIImage (RDYYImageCoder)
...
CG_EXTERN RDYYImageType RDYYImageDetectType(CFDataRef data);

/// Convert RDYYImageType to UTI (such as kUTTypeJPEG).
CG_EXTERN CFStringRef _Nullable RDYYImageTypeToUTType(RDYYImageType type);

/// Convert UTI (such as kUTTypeJPEG) to RDYYImageType.
CG_EXTERN RDYYImageType RDYYImageTypeFromUTType(CFStringRef uti);

/// Get image type's file extension (such as @"jpg").
CG_EXTERN NSString *_Nullable RDYYImageTypeGetExtension(RDYYImageType type);



/// Returns the shared DeviceRGB color space.
CG_EXTERN CGColorSpaceRef RDYYCGColorSpaceGetDeviceRGB();

/// Returns the shared DeviceGray color space.
CG_EXTERN CGColorSpaceRef RDYYCGColorSpaceGetDeviceGray();

/// Returns whether a color space is DeviceRGB.
CG_EXTERN BOOL RDYYCGColorSpaceIsDeviceRGB(CGColorSpaceRef space);

/// Returns whether a color space is DeviceGray.
CG_EXTERN BOOL RDYYCGColorSpaceIsDeviceGray(CGColorSpaceRef space);



/// Convert EXIF orientation value to UIImageOrientation.
CG_EXTERN UIImageOrientation RDYYUIImageOrientationFromEXIFValue(NSInteger value);

/// Convert UIImageOrientation to EXIF orientation value.
CG_EXTERN NSInteger RDYYUIImageOrientationToEXIFValue(UIImageOrientation orientation);
 ...
 */
CG_EXTERN CGImageRef _Nullable RDYYCGImageCreateDecodedCopy(CGImageRef imageRef, BOOL decodeForDisplay);
 ...
 */
CG_EXTERN CGImageRef _Nullable RDYYCGImageCreateCopyWithOrientation(CGImageRef imageRef,
...
/**
 ...
 @return A new image, or NULL if an error occurs.
 */
CG_EXTERN CGImageRef _Nullable RDYYCGImageCreateAffineTransformCopy(CGImageRef imageRef,
 ...
 */
CG_EXTERN CFDataRef _Nullable RDYYCGImageCreateEncodedData(CGImageRef imageRef, RDYYImageType type, CGFloat quality);


/**
 Whether WebP is available in RDYYImage.
 */
CG_EXTERN BOOL RDYYImageWebPAvailable();
 ...
 */
CG_EXTERN NSUInteger RDYYImageGetWebPFrameCount(CFDataRef webpData);
 ...
 */
CG_EXTERN CGImageRef _Nullable RDYYCGImageCreateWithWebPData(CFDataRef webpData,
                                                           BOOL decodeForDisplay,
                                                           BOOL useThreads,
                                                           BOOL bypassFiltering,
                                                           BOOL noFancyUpsampling);

typedef NS_ENUM(NSUInteger, RDYYImagePreset) {
    RDYYImagePresetDefault = 0,  ///< default preset.
    RDYYImagePresetPicture,      ///< digital picture, like portrait, inner shot
    RDYYImagePresetPhoto,        ///< outdoor photograph, with natural lighting
    RDYYImagePresetDrawing,      ///< hand or line drawing, with high-contrast details
    RDYYImagePresetIcon,         ///< small-sized colorful images
    RDYYImagePresetText          ///< text-like
};
...
/**
 ...
 @param preset        Preset for different image type, default is RDYYImagePresetDefault.
 @return WebP data, or nil if an error occurs.
 */
CG_EXTERN CFDataRef _Nullable RDYYCGImageCreateEncodedWebPData(CGImageRef imageRef,
                                                             BOOL lossless,
                                                             CGFloat quality,
                                                             int compressLevel,
                                                             RDYYImagePreset preset);
