...
/**
 ...
 Sample Code:
     ...
     RDYYFrameImage *image = [RDYYFrameImage alloc] initWithImagePaths:paths frameDurations:times repeats:YES];
     RDYYAnimatedImageView *imageView = [RDYYAnimatedImageView alloc] initWithImage:image];
     [view addSubView:imageView];
 */
@interface RDYYFrameImage : UIImage <RDYYAnimatedImage>
...
/**
 ...
 @return An initialized RDYYFrameImage object, or nil when an error occurs.
 */
