...
typedef NS_ENUM(NSInteger, RDAutoScrollDirection) {
    RDAutoScrollDirectionRight,
    RDAutoScrollDirectionLeft
};

@interface RDAutoScrollLabel : UIView <UIScrollViewDelegate>

@property (nonatomic) RDAutoScrollDirection scrollDirection;
