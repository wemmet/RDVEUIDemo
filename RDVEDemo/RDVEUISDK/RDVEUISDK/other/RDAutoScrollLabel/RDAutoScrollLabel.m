...
@implementation RDAutoScrollLabel
...
- (void)commonInit {
    ...
    // default values
    _scrollDirection = RDAutoScrollDirectionLeft;
...
- (void)setScrollDirection:(RDAutoScrollDirection)direction {
...
- (void)scrollLabelIfNeeded {
    ...
    BOOL doScrollLeft = (self.scrollDirection == RDAutoScrollDirectionLeft);
...
- (void)applyGradientMaskForFadeLength:(CGFloat)fadeLength enableFade:(BOOL)fade {
    ...
    if (fadeLength) {
        ...
        if (!fade) switch (self.scrollDirection) {
                case RDAutoScrollDirectionLeft:
                    leftFadePoint = @0;
                    break;

                case RDAutoScrollDirectionRight:
                    leftFadePoint = @0;
                    rightFadePoint = @1;
                    break;
            }
