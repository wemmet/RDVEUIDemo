...
@implementation UIImage (RDVECore)
...
+ (UIImage *) rd_buttonImageWithColor:(UIColor *)color
    ...
    UIImage *topImage = [self rd_ImageWithColor:color cornerRadius:cornerRadius];
    UIImage *bottomImage = [self rd_ImageWithColor:shadowColor cornerRadius:cornerRadius];
    CGFloat totalHeight = rdVESDKedgeSizeFromCornerRadius(cornerRadius) + shadowInsets.top + shadowInsets.bottom;
    CGFloat totalWidth = rdVESDKedgeSizeFromCornerRadius(cornerRadius) + shadowInsets.left + shadowInsets.right;
    CGFloat topWidth = rdVESDKedgeSizeFromCornerRadius(cornerRadius);
    CGFloat topHeight = rdVESDKedgeSizeFromCornerRadius(cornerRadius);
...
+ (UIImage *) rd_backButtonImageWithColor:(UIColor *)color
    ...
    UIBezierPath *path = [self rd_bezierPathForBackButtonInRect:CGRectMake(0, 0, size.width, size.height) cornerRadius:cornerRadius];
...
+ (UIBezierPath *) rd_bezierPathForBackButtonInRect:(CGRect)rect cornerRadius:(CGFloat)radius {
