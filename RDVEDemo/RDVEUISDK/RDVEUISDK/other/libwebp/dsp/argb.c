...
extern void RDVP8EncDspARGBInitMIPSdspR2(void);
extern void RDVP8EncDspARGBInitSSE2(void);

static volatile VP8CPUInfo argb_last_cpuinfo_used =
    (VP8CPUInfo)&argb_last_cpuinfo_used;

WEBP_TSAN_IGNORE_FUNCTION void RDVP8EncDspARGBInit(void) {
  ...
  if (VP8GetCPUInfo != NULL) {
    ...
    if (VP8GetCPUInfo(kSSE2)) {
      RDVP8EncDspARGBInitSSE2();
    }
#endif
#if defined(WEBP_USE_MIPS_DSP_R2)
    if (VP8GetCPUInfo(kMIPSdspR2)) {
      RDVP8EncDspARGBInitMIPSdspR2();
    }
#endif
  }
