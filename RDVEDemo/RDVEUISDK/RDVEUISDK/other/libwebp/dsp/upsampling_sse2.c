...
WEBP_TSAN_IGNORE_FUNCTION void RDWebPInitUpsamplersSSE2(void) {
...
WEBP_TSAN_IGNORE_FUNCTION void RDWebPInitYUV444ConvertersSSE2(void) {
...
WEBP_DSP_INIT_STUB(RDWebPInitYUV444ConvertersSSE2)

#endif  // WEBP_USE_SSE2

#if !(defined(FANCY_UPSAMPLING) && defined(WEBP_USE_SSE2))
WEBP_DSP_INIT_STUB(RDWebPInitUpsamplersSSE2)
#endif
