...
extern void RDVP8LEncDspInitSSE2(void);
extern void RDVP8LEncDspInitSSE41(void);
extern void RDVP8LEncDspInitNEON(void);
extern void RDVP8LEncDspInitMIPS32(void);
extern void RDVP8LEncDspInitMIPSdspR2(void);

static volatile VP8CPUInfo lossless_enc_last_cpuinfo_used =
    (VP8CPUInfo)&lossless_enc_last_cpuinfo_used;

WEBP_TSAN_IGNORE_FUNCTION void RDVP8LEncDspInit(void) {
  ...
  if (VP8GetCPUInfo != NULL) {
    ...
    if (VP8GetCPUInfo(kSSE2)) {
      RDVP8LEncDspInitSSE2();
#if defined(WEBP_USE_SSE41)
      if (VP8GetCPUInfo(kSSE4_1)) {
        RDVP8LEncDspInitSSE41();
      }
#endif
    }
#endif
    ...
    if (VP8GetCPUInfo(kNEON)) {
      RDVP8LEncDspInitNEON();
    }
#endif
#if defined(WEBP_USE_MIPS32)
    if (VP8GetCPUInfo(kMIPS32)) {
      RDVP8LEncDspInitMIPS32();
    }
#endif
#if defined(WEBP_USE_MIPS_DSP_R2)
    if (VP8GetCPUInfo(kMIPSdspR2)) {
      RDVP8LEncDspInitMIPSdspR2();
    }
#endif
  }
