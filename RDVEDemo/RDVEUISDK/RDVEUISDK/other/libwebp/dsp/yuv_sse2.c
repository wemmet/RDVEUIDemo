...
WEBP_TSAN_IGNORE_FUNCTION void RDWebPInitSamplersSSE2(void) {
...
WEBP_TSAN_IGNORE_FUNCTION void RDWebPInitConvertARGBToYUVSSE2(void) {
...
WEBP_DSP_INIT_STUB(RDWebPInitSamplersSSE2)
WEBP_DSP_INIT_STUB(RDWebPInitConvertARGBToYUVSSE2)
