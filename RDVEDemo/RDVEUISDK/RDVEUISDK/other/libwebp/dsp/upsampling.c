...
extern void RDWebPInitYUV444ConvertersMIPSdspR2(void);
extern void RDWebPInitYUV444ConvertersSSE2(void);

static volatile VP8CPUInfo upsampling_last_cpuinfo_used1 =
    (VP8CPUInfo)&upsampling_last_cpuinfo_used1;

WEBP_TSAN_IGNORE_FUNCTION void RDWebPInitYUV444Converters(void) {
  ...
  if (VP8GetCPUInfo != NULL) {
    ...
    if (VP8GetCPUInfo(kSSE2)) {
      RDWebPInitYUV444ConvertersSSE2();
    }
#endif
#if defined(WEBP_USE_MIPS_DSP_R2)
    if (VP8GetCPUInfo(kMIPSdspR2)) {
     RDWebPInitYUV444ConvertersMIPSdspR2();
    }
#endif
  }
...
extern void RDWebPInitUpsamplersSSE2(void);
extern void RDWebPInitUpsamplersNEON(void);
extern void RDWebPInitUpsamplersMIPSdspR2(void);

static volatile VP8CPUInfo upsampling_last_cpuinfo_used2 =
    (VP8CPUInfo)&upsampling_last_cpuinfo_used2;

WEBP_TSAN_IGNORE_FUNCTION void RDWebPInitUpsamplers(void) {
...
#if defined(WEBP_USE_SSE2)
    if (VP8GetCPUInfo(kSSE2)) {
      RDWebPInitUpsamplersSSE2();
    }
#endif
#if defined(WEBP_USE_NEON)
    if (VP8GetCPUInfo(kNEON)) {
      RDWebPInitUpsamplersNEON();
    }
#endif
#if defined(WEBP_USE_MIPS_DSP_R2)
    if (VP8GetCPUInfo(kMIPSdspR2)) {
      RDWebPInitUpsamplersMIPSdspR2();
    }
#endif
  }
#endif  // FANCY_UPSAMPLING
