...
extern VP8Intra4Preds RDVP8EncPredLuma4;
extern VP8IntraPreds RDVP8EncPredLuma16;
extern VP8IntraPreds RDVP8EncPredChroma8;
...
extern VP8QuantizeBlock RDVP8EncQuantizeBlock;
extern VP8Quantize2Blocks RDVP8EncQuantize2Blocks;

// specific to 2nd transform:
typedef int (*VP8QuantizeBlockWHT)(int16_t in[16], int16_t out[16],
                                   const struct VP8Matrix* const mtx);
extern VP8QuantizeBlockWHT RDVP8EncQuantizeBlockWHT;
...
extern const uint8_t RDVP8EncBands[16 + 1];
...
void RDWebPInitUpsamplers(void);
// Must be called before using WebPSamplers[]
void RDWebPInitSamplers(void);
// Must be called before using WebPYUV444Converters[]
void RDWebPInitYUV444Converters(void);
...
void RDWebPInitConvertARGBToYUV(void);
...
void RDWebPInitAlphaProcessing(void);
