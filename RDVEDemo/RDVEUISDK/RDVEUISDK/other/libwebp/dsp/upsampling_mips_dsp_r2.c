...
WEBP_TSAN_IGNORE_FUNCTION void RDWebPInitUpsamplersMIPSdspR2(void) {
...
WEBP_TSAN_IGNORE_FUNCTION void RDWebPInitYUV444ConvertersMIPSdspR2(void) {
...
WEBP_DSP_INIT_STUB(RDWebPInitYUV444ConvertersMIPSdspR2)

#endif  // WEBP_USE_MIPS_DSP_R2

#if 1  // !(defined(FANCY_UPSAMPLING) && defined(WEBP_USE_MIPS_DSP_R2))
WEBP_DSP_INIT_STUB(RDWebPInitUpsamplersMIPSdspR2)
#endif
