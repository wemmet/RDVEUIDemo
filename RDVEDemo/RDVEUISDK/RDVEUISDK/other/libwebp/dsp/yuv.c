...
extern void RDWebPInitSamplersSSE2(void);
extern void RDWebPInitSamplersMIPS32(void);
extern void RDWebPInitSamplersMIPSdspR2(void);

static volatile VP8CPUInfo yuv_last_cpuinfo_used =
    (VP8CPUInfo)&yuv_last_cpuinfo_used;

WEBP_TSAN_IGNORE_FUNCTION void RDWebPInitSamplers(void) {
  ...
  if (VP8GetCPUInfo != NULL) {
    ...
    if (VP8GetCPUInfo(kSSE2)) {
      RDWebPInitSamplersSSE2();
    }
#endif  // WEBP_USE_SSE2
#if defined(WEBP_USE_MIPS32)
    if (VP8GetCPUInfo(kMIPS32)) {
      RDWebPInitSamplersMIPS32();
    }
#endif  // WEBP_USE_MIPS32
#if defined(WEBP_USE_MIPS_DSP_R2)
    if (VP8GetCPUInfo(kMIPSdspR2)) {
      RDWebPInitSamplersMIPSdspR2();
    }
...
extern void RDWebPInitConvertARGBToYUVSSE2(void);

WEBP_TSAN_IGNORE_FUNCTION void RDWebPInitConvertARGBToYUV(void) {
...
#if defined(WEBP_USE_SSE2)
    if (VP8GetCPUInfo(kSSE2)) {
      RDWebPInitConvertARGBToYUVSSE2();
    }
#endif  // WEBP_USE_SSE2
  }
