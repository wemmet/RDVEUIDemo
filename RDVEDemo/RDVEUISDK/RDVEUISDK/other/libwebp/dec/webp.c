...
static VP8StatusCode DecodeInto(const uint8_t* const data, size_t data_size,
  ...
  RDWebPInitCustomIo(params, &io);  // Plug the I/O functions.
...
int RDWebPInitDecoderConfigInternal(WebPDecoderConfig* config,
                                  int version) {
  ...
  RDWebPInitDecBuffer(&config->output);
  return 1;
}
