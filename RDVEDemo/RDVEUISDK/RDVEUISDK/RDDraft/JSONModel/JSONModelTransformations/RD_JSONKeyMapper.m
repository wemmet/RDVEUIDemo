...
@implementation RD_JSONKeyMapper

- (instancetype)initWithJSONToModelBlock:(RD_JSONModelKeyMapBlock)toModel modelToJSONBlock:(RD_JSONModelKeyMapBlock)toJSON
{
...
{
    NSDictionary *toJSON  = [RD_JSONKeyMapper swapKeysAndValuesInDictionary:map];
...
- (RD_JSONModelKeyMapBlock)JSONToModelKeyBlock
{
    return nil;
}
...
+ (instancetype)mapper:(RD_JSONKeyMapper *)baseKeyMapper withExceptions:(NSDictionary *)exceptions
{
    NSDictionary *toJSON = [RD_JSONKeyMapper swapKeysAndValuesInDictionary:exceptions];
