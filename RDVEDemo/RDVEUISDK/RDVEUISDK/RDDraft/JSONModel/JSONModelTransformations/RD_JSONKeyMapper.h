...
typedef NSString *(^RD_JSONModelKeyMapBlock)(NSString *keyName);
 ...
 * </pre>
 */
@interface RD_JSONKeyMapper : NSObject

// deprecated
@property (readonly, nonatomic) RD_JSONModelKeyMapBlock JSONToModelKeyBlock DEPRECATED_ATTRIBUTE;
...
- (instancetype)initWithJSONToModelBlock:(RD_JSONModelKeyMapBlock)toModel modelToJSONBlock:(RD_JSONModelKeyMapBlock)toJSON DEPRECATED_MSG_ATTRIBUTE("use initWithModelToJSONBlock:");
+ (instancetype)mapper:(RD_JSONKeyMapper *)baseKeyMapper withExceptions:(NSDictionary *)exceptions DEPRECATED_MSG_ATTRIBUTE("use baseMapper:withModelToJSONExceptions:");
...
@property (readonly, nonatomic) RD_JSONModelKeyMapBlock modelToJSONKeyBlock;
 ...
 */
- (instancetype)initWithModelToJSONBlock:(RD_JSONModelKeyMapBlock)toJSON;
 ...
 * Use your JSONModel property names as keys, and the JSON key names as values.
 */
+ (instancetype)baseMapper:(RD_JSONKeyMapper *)baseKeyMapper withModelToJSONExceptions:(NSDictionary *)toJSON;
