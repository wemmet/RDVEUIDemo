 ...
 */
@interface NSObject (RD_JSONModelPropertyCompatibility) <Optional, Ignore>
@end
 ...
 * does not have matching transformer method in an RD_JSONValueTransformer.
 */
 ...
 */
@interface RD_JSONModel : NSObject <AbstractJSONModelProtocol, NSSecureCoding>
...
+ (void)setGlobalKeyMapper:(RD_JSONKeyMapper *)globalKeyMapper DEPRECATED_MSG_ATTRIBUTE("override +keyMapper in a base model class instead");
 ...
 * or a property type in your model is not supported by RD_JSONValueTransformer and its categories
 * @see initWithString:usingEncoding:error: for use of custom text encodings
 */
- (instancetype)initWithString:(NSString *)string error:(RD_JSONModelError **)err;
 ...
 * or a property type in your model is not supported by RD_JSONValueTransformer and its categories
 */
- (instancetype)initWithString:(NSString *)string usingEncoding:(NSStringEncoding)encoding error:(RD_JSONModelError **)err;
