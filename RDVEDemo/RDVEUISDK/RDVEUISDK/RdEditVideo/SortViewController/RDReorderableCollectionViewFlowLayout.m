//
//  RDReorderableCollectionViewFlowLayout.m
//
...
@interface UICollectionViewCell (RDReorderableCollectionViewFlowLayout)

- (UIView *)LX_snapshotView;

@end

@implementation UICollectionViewCell (RDReorderableCollectionViewFlowLayout)
...
@interface RDReorderableCollectionViewFlowLayout ()
...
@property (weak, nonatomic, readonly) id<RDReorderableCollectionViewDataSource> dataSource;
@property (weak, nonatomic, readonly) id<RDReorderableCollectionViewDelegateFlowLayout> delegate;

@end

@implementation RDReorderableCollectionViewFlowLayout
...
- (void)setupCollectionView {
    ...
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(handleApplicationWillResignActive:) name: UIApplicationDidEnterBackgroundNotification object:nil];
}
...
- (id<RDReorderableCollectionViewDataSource>)dataSource {
    return (id<RDReorderableCollectionViewDataSource>)self.collectionView.dataSource;
}

- (id<RDReorderableCollectionViewDelegateFlowLayout>)delegate {
    return (id<RDReorderableCollectionViewDelegateFlowLayout>)self.collectionView.delegate;
}
