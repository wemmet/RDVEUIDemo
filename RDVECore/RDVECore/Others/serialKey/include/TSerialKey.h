...
extern "C" {
    ...
    */
    LIBSERIALKEY_API int RDGenerateKey(char* key, int keyLen, const char* secret, unsigned char feature,
    ...
    */
    LIBSERIALKEY_API int RDValidateKey(const char* key, const char* secret, unsigned char feature,
        int* days, const char* userInfo);
