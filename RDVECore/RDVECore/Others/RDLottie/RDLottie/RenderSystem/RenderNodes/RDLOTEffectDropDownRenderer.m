...
- (instancetype)initWithInputNode:(RDLOTAnimatorNode *)inputNode
                                  effectDropDown:(RDLOTEffectDropDown *)dropDown {
  self = [super initWithInputNode:inputNode keyName:dropDown.keyname];
  if (self) {
      
      numInterpolator_ = [[RDLOTNumberInterpolator alloc] initWithKeyframes:dropDown.value.keyframes];
