...
@interface RDGPUImageStillCamera : RDGPUImageVideoCamera
...
- (void)capturePhotoAsJPEGProcessedUpToFilter:(RDGPUImageOutput<RDGPUImageInput> *)finalFilterInChain withOrientation:(UIImageOrientation)orientation withCompletionHandler:(void (^)(NSData *processedJPEG, NSError *error))block;
