...
NSString *const kRDRecordGPUImageThresholdedNonMaximumSuppressionFragmentShaderString = SHADER_STRING
(
...
NSString *const kRDRecordGPUImageThresholdedNonMaximumSuppressionPackedColorspaceFragmentShaderString = SHADER_STRING
(
 uniform sampler2D inputImageTexture;
...
@implementation RDRecordGPUImageThresholdedNonMaximumSuppressionFilter
...
- (id)initWithPackedColorspace:(BOOL)inputUsesPackedColorspace;
{
    ...
    {
        shaderString = kRDRecordGPUImageThresholdedNonMaximumSuppressionPackedColorspaceFragmentShaderString;
    }
    else
    {
        shaderString = kRDRecordGPUImageThresholdedNonMaximumSuppressionFragmentShaderString;
    }
