...
NSString *const kRDRecordGPUImage3x3ConvolutionFragmentShaderString = SHADER_STRING
(
...
@implementation RDRecordGPUImage3x3ConvolutionFilter
...
- (id)init;
{
    if (!(self = [self initWithFragmentShaderFromString:kRDRecordGPUImage3x3ConvolutionFragmentShaderString]))
    {
		return nil;
    }
