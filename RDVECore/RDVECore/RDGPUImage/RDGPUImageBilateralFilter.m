...
NSString *const kRDGPUImageBilateralBlurVertexShaderString = SHADER_STRING
(
...
NSString *const kRDGPUImageBilateralFilterFragmentShaderString = SHADER_STRING
(
...
@implementation RDGPUImageBilateralFilter
...
- (id)init;
{
    ...
    if (!(self = [super initWithFirstStageVertexShaderFromString:kRDGPUImageBilateralBlurVertexShaderString
                              firstStageFragmentShaderFromString:kRDGPUImageBilateralFilterFragmentShaderString
                               secondStageVertexShaderFromString:kRDGPUImageBilateralBlurVertexShaderString
                             secondStageFragmentShaderFromString:kRDGPUImageBilateralFilterFragmentShaderString])) {
        return nil;
    }
