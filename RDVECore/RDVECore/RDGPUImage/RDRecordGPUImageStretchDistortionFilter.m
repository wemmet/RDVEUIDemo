...
NSString *const kRDRecordGPUImageStretchDistortionFragmentShaderString = SHADER_STRING
(
...
@implementation RDRecordGPUImageStretchDistortionFilter
...
- (id)init;
{
    if (!(self = [super initWithFragmentShaderFromString:kRDRecordGPUImageStretchDistortionFragmentShaderString]))
    {
		return nil;
    }
