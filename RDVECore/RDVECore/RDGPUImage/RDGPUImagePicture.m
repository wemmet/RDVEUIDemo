...
@implementation RDGPUImagePicture
...
- (id)initWithCGImage:(CGImageRef)newImageSource smoothlyScaleOutput:(BOOL)smoothlyScaleOutput;
{
    ...
    CGSize scaledImageSizeToFitOnGPU = [RDGPUImageContext sizeThatFitsWithinATextureForSize:pixelSizeOfImage];
    ...
    rdRunSynchronouslyOnVideoProcessingQueue(^{
        ...
        outputFramebuffer = [[RDGPUImageContext sharedFramebufferCache] fetchFramebufferForSize:pixelSizeToUseForTexture onlyTexture:YES];
...
- (void)processImageUpToFilter:(RDGPUImageOutput<RDGPUImageInput> *)finalFilterInChain withCompletionHandler:(void (^)(UIImage *processedImage))block;
{
