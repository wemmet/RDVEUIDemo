...
NSString *const kRDGPUImageCropFragmentShaderString =  SHADER_STRING
(
...
@interface RDGPUImageCropFilter ()
...
@implementation RDGPUImageCropFilter
...
{
    if (!(self = [super initWithFragmentShaderFromString:kRDGPUImageCropFragmentShaderString]))
    {
        return nil;
    }
...
- (void)calculateCropTextureCoordinates;
{
    ...
    {
        case kRDGPUImageNoRotation: // Works
        {
        ...
        case kRDGPUImageRotateLeft: // Fixed
        {
        ...
        case kRDGPUImageRotateRight: // Fixed
        {
        ...
        case kRDGPUImageFlipVertical: // Works for me
        {
        ...
        case kRDGPUImageFlipHorizonal: // Works for me
        {
        ...
        case kRDGPUImageRotate180: // Fixed
        {
        ...
        case kRDGPUImageRotateRightFlipVertical: // Fixed
        {
        ...
        case kRDGPUImageRotateRightFlipHorizontal: // Fixed
        {
