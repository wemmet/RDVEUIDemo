...
NSString *const kRDGPUImageSaturationFragmentShaderString = SHADER_STRING
(
...
@implementation RDGPUImageSaturationFilter
...
- (id)init;
{
    if (!(self = [super initWithFragmentShaderFromString:kRDGPUImageSaturationFragmentShaderString]))
    {
		return nil;
    }
