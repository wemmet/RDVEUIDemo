...
NSString *const kRDGPUImageWhiteBalanceFragmentShaderString = SHADER_STRING
(
...
@implementation RDGPUImageWhiteBalanceFilter
...
- (id)init;
{
    if (!(self = [super initWithFragmentShaderFromString:kRDGPUImageWhiteBalanceFragmentShaderString]))
    {
		return nil;
    }
