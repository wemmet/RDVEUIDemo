...
NSString *const kRDGPUImageSharpenVertexShaderString = SHADER_STRING
(
...
NSString *const kRDGPUImageSharpenFragmentShaderString = SHADER_STRING
(
...
@implementation RDGPUImageSharpenFilter
...
- (id)init;
{
    if (!(self = [super initWithVertexShaderFromString:kRDGPUImageSharpenVertexShaderString fragmentShaderFromString:kRDGPUImageSharpenFragmentShaderString]))
    {
		return nil;
    }
